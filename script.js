...
const firebaseConfig = {
  ...
  storageBucket: "gerenciadordetarefas-b740b.firebasestorage.app",
...
function renderTasks(tasks) {
    ...
    // Adicionando o ouvinte de evento para os botões "Concluir" ou "Desfazer"
    ...
    // Adicionando o ouvinte de evento para os ícones de exclusão
...
function deleteTask(index) {
    get(tasksRef).then((snapshot) => {
        const tasks = snapshot.val() || [];
        tasks.splice(index, 1); // Remove a tarefa com o índice fornecido
        set(tasksRef, tasks); // Atualiza o banco de dados com a nova lista de tarefas
    });
}
